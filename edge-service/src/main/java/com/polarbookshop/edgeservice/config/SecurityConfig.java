...
public class SecurityConfig {
    ...
    @Bean
    SecurityWebFilterChain springSecurityWebFilterChainBean(
        ...
        return http.
                ...
                .logout(
                        logout -> logout.logoutSuccessHandler(oidcLogoutSuccessHandler(clientRegistrationRepository))
                )
    ...
    private ServerLogoutSuccessHandler oidcLogoutSuccessHandler(
        ...
        oidcLogoutSuccessHandler.setPostLogoutRedirectUri("{baseUr}");
